/// ============================================
/// APP CONSTANTS - Không có magic numbers
/// ============================================
...
class MapConfig {
  ...
  /// Default center position (TP.HCM)
...
class BluetoothConfig {
  ...
  /// MCU Service/Characteristic UUIDs (cần điều chỉnh theo MCU của bạn)
  /// ============================================
  /// 🔧 CHỈNH SỬA UUID THEO MCU CỦA BẠN TẠI ĐÂY
  /// ============================================
